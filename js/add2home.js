...
var addToHome = (function (w) {
	...
	function loaded () {
        ...
        else if (isChrome && (chromeItem != "https://chrome.google.com/webstore/detail/%CHROME_STORE_ID%"))
        {
          console.log("chromeItem " + chromeItem);
  ...
  xobj.onreadystatechange = function () {
    if (xobj.readyState == 4 && xobj.status == "200") {
      ...
      chromeItem='https://chrome.google.com/webstore/detail/' + jsonresponse[0].chromeItem;
